  ...
  return (
    <div className='flex items-center h-12 p-2 justify-between bg-indigo-400 text-white'>
        ...
        <div className='flex h-12 p-2 gap-2  items-center gap-2' > 
            ...
            <button className=' rounded-md border bg-white text-black my-1 py-1 px-4 text-sm shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2' onClick={()=> redirectToProfile()}> exit</button>
        </div>
    </div>
  )
}
