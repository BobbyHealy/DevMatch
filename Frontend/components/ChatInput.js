...
export default function ChatInput({DMID, receiver}) {
    ...
    return (
        <div className='h-12 bg-zinc-600  rounded-lg p-2 flex items-center justify-between'>
            {receiver&&<input type="text" placeholder='input'  onChange={(e) => setText(e.target.value)}  value={text}    onKeyDown={handleKey} className='bg-transparent textblack text-lg border-none outline-none placeholder-gray-400 w-full' />}
