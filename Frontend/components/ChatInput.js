...
export default function ChatInput({DMID, receiver}) {
    ...
    return (
        <div className='h-12 bg-orange-200 p-2 flex items-center justify-between'>
            {receiver&&<input type="text" placeholder='input'  onChange={(e) => setText(e.target.value)}  value={text}    onKeyDown={handleKey} className='w-full bg-transparent text-gray-600 text-lg border-none outline-none placeholder-gray-400' />}
