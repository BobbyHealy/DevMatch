...
function profile(){
  ...
  const profileImageURL = "https://cdn.britannica.com/79/114979-050-EA390E84/ruins-St-Andrews-Castle-Scotland.jpg"
  const user = {
    name: "Auden Huang",
    imageUrl:
    ...
    description:'A third year CS student looking fro projectmate for CS307 Project',
    infos: {
      Phone: '(765) 418-0737',
      ...
      <div className=" fixed top-0 left-0 right-0 h-full bg-white overflow-scroll">
            ...
            <div className="flex mx-auto mt-6 max-w-5xl px-4 sm:px-6 lg:px-8">
                ...
                {Object.keys(user.infos).map((info) => (
                    ...
                    <dd className="mt-1 text-sm text-gray-900">{user.infos[info]}</dd>
                    </div>
                ))}
