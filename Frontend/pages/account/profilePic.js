        ...
        <div className=" fixed top-0 left-0 right-0 h-full bg-white">
            <div className="profile_img text-center p-4">
                ...
                {!image&&<InputText type = "file" 
                    ...
                    />}
                    {image&&<button className="rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
